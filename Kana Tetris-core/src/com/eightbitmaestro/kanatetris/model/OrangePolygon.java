...
public class OrangePolygon extends Polygon{
	

	public OrangePolygon(Vector2 position, float width, float height) {
		...
		blocks.add(new Block(new Vector2(position.x+width*2, position.y+height), width, height, color));
	}
